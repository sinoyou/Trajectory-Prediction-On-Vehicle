...
class SingleKittiDataLoader:
    ...
    """
    def __init__(self, file_path, batch_size, trajectory_length, device, seed=17373321, leave_scene = None, valid_scene = None):
        self.count = 0
        ...
        random.seed(seed)
        random.shuffle(self.data, random=ramdom.random)
    ...
    def preprocess(self, raw):
        ...
        for scene in scenes:
            ...
            for vru in vru_ids:
                ...
                vru_traj = vru_traj.sort_values(by = 'frame')
